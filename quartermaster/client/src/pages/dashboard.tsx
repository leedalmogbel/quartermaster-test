...
export default function Dashboard() {
  ...
  const { data: reports, isLoading: reportsLoading } = useQuery<WeeklyReport[]>({
    ...
    queryFn: async () => {
      const res = await apiRequest("GET", `/api/practices/${practiceId}/reports`);
      return res.json();
    },
  });
  ...
  const { data: marketingHistory } = useQuery<MarketingDataRow[]>({
    ...
    queryFn: async () => {
      const res = await apiRequest("GET", `/api/practices/${practiceId}/marketing`);
      return res.json();
    },
  });
  ...
  const { data: forecast } = useQuery<Forecast>({
    ...
    queryFn: async () => {
      const res = await apiRequest("GET", `/api/practices/${practiceId}/forecast`);
      return res.json();
    },
  });
  ...
  const { data: actions } = useQuery<ActionItem[]>({
    ...
    queryFn: async () => {
      const res = await apiRequest("GET", `/api/practices/${practiceId}/actions`);
      return res.json();
    },
  });
